...
function ExperienceTab() {
    ...
    let experiences = [
        {title: "Regedge LLC", desc: "Worked as a data engineer, developing, and automating reports for end-users, worked on ETL data pipelines, handled efficient and fast data transformation.", position: "Data Engineer", date: "May 25 - Sept 25", desc_sec: "Python Automation, Numpy, Pandas, AWS Lambda, Informatica, OracleSQL"},
        {title: "Development Monitors LLC", desc: "Worked as a software developer, mentoring a team of 6 interns to develop a QGIS plugin, for Birendranagar municipality to map, study interaction of Water Supply system with Eartquake and Landslide risk.", position: "Software developer", date: "April 24 - April 25", desc_sec: "Python - PyQT5, Numpy, Java - XML Processing, PostgreSQL"},
