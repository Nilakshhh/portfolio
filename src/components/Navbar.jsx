      ...
      <div className='flex justify-center items-center'>
         <div className='mt-[24px] w-[80vw] sm:w-[20vw] h-[8vh] border-[2.5px] border-[color:#423F3E] rounded-[24px] svg-container flex justify-center items-center'>
            <div className="relative w-[12vw] sm:w-[4vw] h-[8vh] flex items-center justify-center group">
               ...
               <span className="nav-text-box absolute opacity-0 translate-y-[-30px] group-hover:opacity-100 group-hover:translate-y-[0px] transition-all duration-500 bottom-[-36px] w-[10vw] sm:w-[3.5vw] h-[3.5vh] text-white flex items-center justify-center rounded-[12px] border-0 bg-[#423F3E]">
